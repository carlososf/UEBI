    ...
    return (
        <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0A0A0A]">
            ...
            >
                ...
                >
                    <span className="text-white font-black text-sm sm:text-xl md:text-2xl tracking-[0.3em] sm:tracking-[0.5em] uppercase hover:text-[#39FF14] drop-shadow-[0_0_15px_rgba(57,255,20,0.5)] transition-all duration-300 cursor-default">
                        UEBI STUDIO
                    </span>
                </motion.div>

                {/* 2. Main Headline (Authority & Power) */}
                <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white leading-[1.1] md:leading-[0.9] select-none text-center mix-blend-screen max-w-6xl mx-auto mb-6">
                ...
                <motion.div
                    ...
                    className="mt-6 md:mt-8 text-lg sm:text-xl md:text-3xl font-light text-white/80 max-w-3xl text-center leading-tight tracking-wide space-y-1 md:space-y-2"
                >
                ...
                >
                    {/* Primary CTA */}
                    <a href="#contact" className="relative w-full sm:w-auto justify-center px-10 py-4 md:py-5 bg-[#39FF14] text-black font-bold rounded-full overflow-hidden group shadow-[0_0_50px_rgba(57,255,20,0.2)] hover:shadow-[0_0_80px_rgba(57,255,20,0.5)] transition-all duration-300">
                    ...
                    {/* Secondary CTA */}
                    <a href="#portfolio" className="w-full sm:w-auto text-center px-10 py-4 md:py-5 border border-white/10 text-white/60 font-medium rounded-full hover:bg-white/5 hover:border-white/40 hover:text-white transition-all duration-300 text-sm tracking-widest uppercase backdrop-blur-sm">
                        Ver Portfolio
                    </a>
                </motion.div>
            </motion.div>
