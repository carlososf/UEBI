...
export default function Process() {
    ...
    return (
        <section className="py-32 px-4 bg-[#0A0A0A] text-white overflow-hidden relative" id="process">
            {/* Background Tech Elements */}
            <div className="absolute right-0 top-0 w-1/3 h-full bg-gradient-to-l from-[#39FF14]/5 to-transparent pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center" ref={ref}>
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#39FF14]/30 bg-[#39FF14]/5 backdrop-blur-md mb-8">
                ...
                <div className="relative">
                    {/* Connecting Line */}
                    <div className="absolute left-[27px] top-8 bottom-8 w-[2px] bg-gradient-to-b from-[#39FF14] via-[#39FF14]/20 to-transparent opacity-30" />
                    ...
                    <div className="flex flex-col gap-10">
                        {steps.map((step, i) => (
                            ...
                            >
                                <div className="relative z-10 w-14 h-14 rounded-xl bg-[#111] border border-white/10 flex items-center justify-center text-xl font-mono font-bold text-white/30 group-hover:text-[#39FF14] group-hover:border-[#39FF14] group-hover:shadow-[0_0_20px_rgba(57,255,20,0.2)] transition-all duration-500 shadow-xl">
                                    {step.id}
                                </div>
                                <div className="flex-1 p-6 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-500 backdrop-blur-sm">
                                    <h3 className="text-xl font-bold mb-1 text-white group-hover:text-[#39FF14] transition-colors">{step.title}</h3>
